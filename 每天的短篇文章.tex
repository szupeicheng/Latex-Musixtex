...
\noindent
\par 15 \^{E}-hng \dotfill 8 \\ 
Thi{\nn}-p\={e} khi\={a}-kh\'{\i} ch\`{\i}-ko\^{a}n thi{\nn}-t\'{e}ng \\
\par 18 \`{A}m-m\^{\i} \dotfill 9 \\
...
\par Ch\'{u}-j\pehin{\i}t \dotfill 11 \\
...
\par
Chheng-ch\'{a} sim-s\^{\i}n kap j\siin{\i}t p\^{\i}\hspace{.5pt}{\nn} kh\'{\i}, Che l\^{a}ng h\siin{a}p-s\^{\i} h\'{\i}-l\siin{o}k b\^{o} p\'{\i}, K\`{\i}{\nn}-ti\siin{o}h Si\={o}ng-t\`{e} \^{e}ng-kng \^{e} b\={\i}n, B\={a}n-m\siin{\i}h t\`{u}i I s\^{\i}-si\^{o}ng o\={a}{\nn} sin! 
%\rmfamily
\textsuperscript{2}Si\={o}ng-t\`{e} thi\`{a}{\nn}-th\`{a}ng t\siin{a}k j\siin{\i}t t\^{e}ng-sin, T\`{u}i l\'{a}n kh\`{u}n-chh\'{\i}\hspace*{.5pt}{\nn} pi\'{a}u-b\^{e}ng s\={\i} chin, Chh\={o}a l\'{a}n p\^{e}ng-an keng-k\`{e} \`{a}m-m\^{\i},  Khoe-h\siin{o}k o\siin{a}h-mi\={a}, kh\`{u}i-l\siin{a}t, sim-ch\`{\i}. 
\textsuperscript{3}Siat-s\'{u} sim-s\^{\i}n t\siin{a}k-j\siin{\i}t t\`{\i}-\`{\i}, S\`{e}ng-h\`{o}a it-chh\`{e} kang-chok \^{e} s\^{\i}, Si\={o}ng-t\`{e} p\={\i}-p\={a}n b\^{o} h\={a}n ch\^{a}i-p\'{o}, P\(\dotr{\text{\'{o}}}\) l\'{a}n it-chh\`{e} hi-seng, l\^{o}-kh\(\dotr{\text{\'{o}}}\). 
\textsuperscript{4}Chiu-\^{u}i ph\(\dotr{\text{\'{o}}}\)-thong si\'{o}-kh\'{o}a khang-kh\`{e}, I\={a}-\={o}e h\(\dotr{\text{\={o}}}\) l\'{a}n tit-ti\siin{o}h ki-h\={o}e, Ch\={\i}n-li\={o}ng khek-k\'{\i}, kh\`{o}a{\nn} b\^{o} ka-k\={\i}, J\pehin{\i}t-j\pehin{\i}t k\={u}n-o\'{a} Si\={o}ng-t\`{e} sin-pi{\nn}.
%\textit{Ch\={\i}n-li\={o}ng khek-k\'{\i}, kh\`{o}a{\nn} b\^{o} ka-k\={\i}. J\pehinrmit{\i}t-j\pehinrmit{\i}t k\={u}n-o\'{a} Si\={o}ng-t\`{e} sin-pi{\nn}.}
\textsuperscript{5}Ch\'{\i}-\={u} t\={\i} Ch\'{u} L\'{\i} thi\`{a}{\nn} l\={a}i-b\={\i}n, O\={e} s\`{u} si\siin{o}k thi{\nn} p\^{e}ng-an b\^{o} ch\={\i}n, Kim-j\siin{\i}t \'{\i}-a\={u} ki\^{u} L\'{\i} ch\={a}n go\'{a}n, Chi\`{a}u go\'{a}n s\(\dotr{\text{\'{o}}}\) ki\^{u} ki\^{a}\hspace*{.5pt}{\nn} k\`{a}u o\^{a}n-cho\^{a}n. \\
%}
}
{\bsifamily
\par
...
\par
Kh\'{u}n-ki\^{u} S\`{e}ng S\^{\i}n s\`{u} go\'{a}n un-h\={u}i, U\={\i} Ch\'{u} ch\`{o}e kang l\'{o}ng bi\'{a}n th\'{o}{\dtr}-kh\`{u}i; Ke-l\={a}i t\={o}a-s\`{o}e t\^{a}ng-sim h\^{o}-p\^{e}ng, It-chh\`{e} ph\'{a}i{\nn}-t\={a}i ki\^{u} L\'{\i} s\'{o}e chheng. \textsuperscript{1}Kh\'{u}n-ki\^{u} S\`{e}ng S\^{\i}n t\`{u}i thi{\nn} k\`{a}ng-l\^{\i}m, E\={n}g thi{\nn} \^{e} h\'{e} chi\`{o} kng g\'{o}an sim; L\'{\i} t\`{u}i thi{\nn}-t\'{e}ng l\^{\i}m-k\`{a}u t\={o}e-b\={\i}n, Un-s\`{u} m\'{o}a-m\'{o}a beh h\={o}{\dtr} b\={a}n-b\^{\i}n. 
\textsuperscript{2}L\'{\i} s\'{o}{\dtr} h\={o}{\dtr} go\'{a}n si\pehin{o}k-l\^{e}ng un-s\`{u}, J\^{\i}n-\`{a}i o\pehin{a}h-mi\={a}, an-\`{u}i l\'{o}ng \={u}; Go\'{a}n \^{e} sim-b\pehin{a}k b\={u}-b\={u} b\^{o} b\^{e}ng, L\'{\i} s\`{u} kng-b\^{e}ng h\={o}{\dtr} g\'{o}an cheng-eng. 
\textsuperscript{4}K\`{a} go\'{a}n chai-bat S\`{e}ng P\={e} Si\={o}ng-t\`{e}, S\`{e}ng Ki\'{a}{\nn}, S\`{e}ng S\^{\i}n p\'{u}n s\={\i} ch\pehin{\i}t \^{e}; Go\'{a}n \`{a}i \={e}ng che ch\`{o}e si l\^{a}i g\^{\i}m, E\'{n}g-o\'{a}n chhut t\`{u}i ch\`{e}ng l\^{a}ng \^{e} sim.\\
}
{\rmfamily
\par
...
\par
\textsuperscript{1}Thi{\nn}-p\={e} khi\={a}-kh\'{\i} ch\`{\i}-ko\^{a}n thi{\nn}-t\'{e}ng, Go\'{a}n \^{e}-hng teh g\^{\i}m-si kiong-k\`{e}ng, L\'{\i} \^{e} ch\^{u}-pi \'{e}ng b\^{o} th\^{e}ng, L\'{\i} \={e}ng j\^{\i}n-\`{a}i thong-j\pehin{\i}t khan go\'{a}n, S\^{\i}-si\^{o}ng kh\`{o}a{\nn}-k\`{o}{\dtr} p\'{o} go\'{a}n an-cho\^{a}n, Ch\'{u} \^{e} j\^{\i}n-ch\^{u} k\`{a}u \'{e}ng-o\'{a}n. 
\textsuperscript{2}Ki\^{u} Ch\'{u} si\`{a}-bi\'{a}n s\'{o}{\dtr} ho\={a}n ch\={o}e-k\`{o}a, Sim-su si\^{a}-ok, h\^{e}ng-\^{u}i oai-chho\pehin{a}h, O\`{a}n-t\`{o}{\dtr}, kiau-ng\={o}{\dtr} kap hu-hoa, Ki\`{u} go\'{a}n thoat-l\={\i} si\pehin{o}k-ch\^{e}ng sit-chh\`{o}, Chit s\^{\i} ki\`{u} go\'{a}n bi\'{a}n si\={u} chai-h\={o}, S\pehin{\i}p-j\={\i}-k\`{e} t\'{e}ng S\`{e}ng I\^{u}{\nn}-ko. \textsuperscript{3}Ki\^{u} Ch\'{u} ch\`{o}e go\'{a}n chi\`{a}n-kah t\^{\i}n-p\^{a}i, T\'{\i}-t\pehin{e}k M\^{o}{\dtr}-k\'{u}i, kh\'{u}i-k\`{e} h\={a}m-h\={a}i, T\'{u}-ti\pehin{o}h chh\`{\i}-li\={a}n i\={a} khi\={a}-ch\={a}i, Go\={a}n Ch\'{u} kh\`{u}i-l\pehin{a}t kim-m\^{\i} p\'{o}-h\={o}{\dtr}, S\`{u} go\'{a}n p\^{e}ng-an k\'{o}a{\nn}-chhut chai-h\={o}, Chhe s\`{e}ng-s\`{a}i chi\`{a}u-k\`{o}{\dtr} h\^{u}-ch\={o}{\dtr}.\\
\textsuperscript{4}Ti\={a}m-ch\={e}ng \`{a}m-m\^{\i} l\={o}{\dtr}-ch\'{u}i teh tih, Kh\'{u}n-ki\^{u} S\`{e}ng S\^{\i}n h\^{u}-chh\^{\i} p\'{o}-p\`{\i}, H\={o}{\dtr} go\'{a}n an-l\^{e}ng bi\'{a}n kh\`{o}a-\`{\i},\ Kh\'{u}n-ki\^{u} Sam-\={u}i-it-th\'{e} Si\={o}ng-t\`{e}, H\={o}{\dtr} go\'{a}n t\pehin{a}k l\^{a}ng b\pehin{a}k-chiu p\`{a}ng-khoeh, An-b\^{\i}n hioh t\={\i} L\'{\i} s\pehin{\i}t-\={e}. 
}
...
\par
I\^{a}-h\^{o}-hoa si\'{u}\hspace*{.5pt}{\nn}-s\`{u}, I\^{a}-h\^{o}-hoa th\pehin{e}h kh\`{\i}, ti\pehin{o}h o-l\'{o} I\^{a}-h\^{o}-hoa \^{e} mi\^{a}. (Iok-pek 1:21 b)\\
\par
P\={e}-b\'{u} hia{\nn}-t\hspace*{.5pt}\={\i} chhin-l\^{a}ng, \={M}-bi\'{a}n iu-b\={u}n kh\'{o}{\dtr}-th\`{a}ng; B\^{o} k\'{u} i\^{u}-go\^{a}n chi\^{a}\hspace*{.5pt}{\nn}-ch\`{o}e ch\pehin{\i}t ke, Kap Ch\'{u} hi\'{o}ng-hok b\^{o}-th\`{e}. \textsuperscript{1}Thian-t\^{o}ng k\pehin{e}k-h\'{o} s\'{o}{\dtr}-ch\={a}i, Thi\hspace{1pt}{\nn}-s\`{a}i chhi\`{u}\hspace{1pt}{\nn}-koa h\^{o}-h\^{a}i, S\`{\i}n-Ch\'{u} \^{e} l\^{a}ng s\`{o}e-ki\'{a}\hspace{1pt}{\nn} k\`{e}-s\`{\i},T\={\i} hia hi\'{o}ng-si\={u} hok-kh\`{\i}. \hspace{.7mm} \textsuperscript{2}S\`{o}e-ki\'{a}\hspace{1pt}{\nn} i\={a} \={u} ch\={o}e-kun, Kh\`{o} Ch\'{u} chi\={u} bi\'{a}n t\hspace*{.5pt}\^{\i}m-l\^{u}n ; Ta{\nn} kui thian-t\hspace*{.5pt}\^{o}ng \'{e}ng-o\'{a}n hi\'{o}ng-hok, T\={\i} hia kap Ch\'{u} kho\`{a}i-l\hspace*{.5pt}\pehin{o}k. \textsuperscript{3}Thi\hspace{1pt}{\nn} P\={e} chiong che ki\'{a}\hspace*{.5pt}{\nn}-j\^{\i}, Thok l\'{a}n k\`{a}-s\={\i} i\'{u}\hspace*{.5pt}{\nn}-chh\={\i}, Ta{\nn} Ch\'{u} thi\`{a}\hspace*{.5pt}{\nn}-sioh ti\`{a}u i chi\={u}\hspace*{.5pt}{\nn}-thi\hspace{1pt}{\nn}, Chi\={a}m-s\^{\i} kap l\'{a}n sa{\nn}-l\hspace*{.5pt}\={\i}.\\
}
{\rmfamily%\sffamily
\par
SI-PHIAN 39\\
